...
http.createServer(function(req, res){
    switch(req.url){
        case '/form':
            if(req.method == 'POST'){
                ...
                req.on('end', function(){
                    ...
                    res.write('<style>th, td {text-algin:left; padding:5px; color:black}\n');
                    ...
                    res.write('<table boder="1"><caption>Form Data</caption>');
        ...
        default:
            ...
            res.end('<html><head><title>404 - Not found</title></head><body>' + '<h1>Method not supported.</h1></body></html>');
